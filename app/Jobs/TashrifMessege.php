...
class TashrifMessege implements ShouldQueue{
    ...
    public function handle(): void{
        ...
        if($SmsCentar=='on'){
            ...
            $this->SendMessege->status = "Yangi tashriflar uchun sms xizmati o'chirilgan.";
        }
